...
class plgUserMailchimp extends JPlugin
{
	...
	function onUserAfterSave($user, $isnew, $success, $msg)
	{
        ...
        if($user) {
    		...
    		require_once(JPATH_PLUGINS.'/user/mailchimp/MCAPI.class.php');
    		...
    		if ($isnew)
    		{
    			if( $api->listSubscribe( $mc_listid,
    				$user['email'], $mergeVars, 'html',
    				$mc_autoregister ) === true
    			) {
    				// You have just launched a nuclear warhead - what a success
    			}else{
    				// Ekk - epic failure
    		...
    		{
    			//This user is not new - do nothing
    		}
        }
	}
}
